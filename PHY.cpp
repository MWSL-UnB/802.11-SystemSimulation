...
const double min_thresh[8] = {-2.5103, 0.75061,  0.5000,  3.7609,
                               5.5103, 9.2712 , 12.5206, 14.5321};
const double max_thresh[8] = { 1.9897,  5.2506,  5.0000,  8.2609,
                              10.5103, 14.7712, 18.5206, 20.0321};

const int n_coeff = 5;
const double coeff[8][5] = {
...
const double coeff_high[8][2] = { {-2.3974,-1.1580}, { 2.8250,-1.4824},
